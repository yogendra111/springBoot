...
public class JwtUtils {
    ...
    @Value("${demoSecurity.app.jwtSecret}")
    private String jwtSecretKey;
    @Value("${demoSecurity.app.jwtExpirationMs}")
    private int jwtExpirationMs;
    @Value("${demoSecurity.app.jwtCookie}")
    ...
    public ResponseCookie getCleanJwtCookie(){
        ResponseCookie responseCookie = ResponseCookie.from(jwtCookie, null).path("/").build();
